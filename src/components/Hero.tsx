        ...
        <div className="relative pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-32 lg:pb-28">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
              Discover our premium footwear collection, designed to elevate your professional 
              look and keep you comfortable throughout your day. Step into success with 
              Professional Shoes.
            </p>
